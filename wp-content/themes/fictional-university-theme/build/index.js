...
/* harmony import */ var _modules_MyNotes_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/MyNotes.js */ "./src/modules/MyNotes.js");
...
const myNotes = new _modules_MyNotes_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`
                <li data-id="${response.id}">
                    <input readonly class="note-title-field" value="${response.title.raw}" type="text" name="" id="">
